...
public class SearchInvitationsQueryHandlerTests
{
    ...
    {
        CampaignInvitation pending = TestCampaignInvitation.Create(1, campaignId: 1, "a@b.com", "h1", Expiry);
        CampaignInvitation accepted = TestCampaignInvitation.Create(2, campaignId: 1, "c@d.com", "h2", Expiry, InvitationStatus.Accepted);
        CampaignInvitation otherCampaign = TestCampaignInvitation.Create(3, campaignId: 2, "e@f.com", "h3", Expiry);
